...
describe AnecdotesController do
  ...
  let(:valid_attributes) { { "sujet" => "MyText", "theme" => "MyText2" }}
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested anecdote" do
        ...
        Anecdote.any_instance.should_receive(:update).with({ "sujet" => "MyText" })
        put :update, {:id => anecdote.to_param, :anecdote => { "sujet" => "MyText" }}, valid_session
      end
